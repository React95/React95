...
const StyledTab = styled.button<StyledTabProps>`
  ...
  padding: ${({ isActive }) => (isActive ? 5 : 3)}px
    ${({ isActive }) => (isActive ? 9 : 7)}px;
  ...
  &:first-child {
    ...
    :after {
      box-shadow: ${({ isActive, theme }) => `
          ...
          inset 0 1px 0 0 ${
            isActive ? theme.colors.material : theme.colors.borderLightest
          }, 
          inset 0 -1px 0 0 ${
            isActive ? theme.colors.material : theme.colors.borderLight
          }
      `};
    }
  }
