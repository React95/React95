...
const Inetcpl1307Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1307Props) => {
  const Svg = inetcpl1307Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1307 = React.memo(Inetcpl1307Component);
