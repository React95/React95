...
const Progman20Component = ({
  variant = '32x32_1',
  ...rest
}: Progman20Props) => {
  const Svg = progman20Data[variant];

  return <Svg {...rest} />;
};

export const Progman20 = React.memo(Progman20Component);
