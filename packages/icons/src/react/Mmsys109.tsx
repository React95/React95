...
const Mmsys109Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys109Props) => {
  const Svg = mmsys109Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys109 = React.memo(Mmsys109Component);
