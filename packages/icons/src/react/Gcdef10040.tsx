...
const Gcdef10040Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10040Props) => {
  const Svg = gcdef10040Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10040 = React.memo(Gcdef10040Component);
