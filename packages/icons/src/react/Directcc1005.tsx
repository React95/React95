...
const Directcc1005Component = ({
  variant = '32x32_4',
  ...rest
}: Directcc1005Props) => {
  const Svg = directcc1005Data[variant];

  return <Svg {...rest} />;
};

export const Directcc1005 = React.memo(Directcc1005Component);
