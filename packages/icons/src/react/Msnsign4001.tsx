...
const Msnsign4001Component = ({
  variant = '32x32_4',
  ...rest
}: Msnsign4001Props) => {
  const Svg = msnsign4001Data[variant];

  return <Svg {...rest} />;
};

export const Msnsign4001 = React.memo(Msnsign4001Component);
