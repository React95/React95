...
const Inetcfg2302Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcfg2302Props) => {
  const Svg = inetcfg2302Data[variant];

  return <Svg {...rest} />;
};

export const Inetcfg2302 = React.memo(Inetcfg2302Component);
