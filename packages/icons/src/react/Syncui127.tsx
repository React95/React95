...
const Syncui127Component = ({
  variant = '32x32_4',
  ...rest
}: Syncui127Props) => {
  const Svg = syncui127Data[variant];

  return <Svg {...rest} />;
};

export const Syncui127 = React.memo(Syncui127Component);
