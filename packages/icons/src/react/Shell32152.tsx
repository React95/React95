...
const Shell32152Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32152Props) => {
  const Svg = shell32152Data[variant];

  return <Svg {...rest} />;
};

export const Shell32152 = React.memo(Shell32152Component);
