...
const Gcdef10038Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10038Props) => {
  const Svg = gcdef10038Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10038 = React.memo(Gcdef10038Component);
