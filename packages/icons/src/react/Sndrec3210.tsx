...
const Sndrec3210Component = ({
  variant = '32x32_4',
  ...rest
}: Sndrec3210Props) => {
  const Svg = sndrec3210Data[variant];

  return <Svg {...rest} />;
};

export const Sndrec3210 = React.memo(Sndrec3210Component);
