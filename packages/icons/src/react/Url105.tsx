...
const Url105Component = ({
  variant = '32x32_4',
  ...rest
}: Url105Props) => {
  const Svg = url105Data[variant];

  return <Svg {...rest} />;
};

export const Url105 = React.memo(Url105Component);
