...
const Shell32144Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32144Props) => {
  const Svg = shell32144Data[variant];

  return <Svg {...rest} />;
};

export const Shell32144 = React.memo(Shell32144Component);
