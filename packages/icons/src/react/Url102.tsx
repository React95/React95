...
const Url102Component = ({
  variant = '32x32_4',
  ...rest
}: Url102Props) => {
  const Svg = url102Data[variant];

  return <Svg {...rest} />;
};

export const Url102 = React.memo(Url102Component);
