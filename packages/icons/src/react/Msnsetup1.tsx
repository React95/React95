...
const Msnsetup1Component = ({
  variant = '32x32_4',
  ...rest
}: Msnsetup1Props) => {
  const Svg = msnsetup1Data[variant];

  return <Svg {...rest} />;
};

export const Msnsetup1 = React.memo(Msnsetup1Component);
