...
const Mailnews22Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews22Props) => {
  const Svg = mailnews22Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews22 = React.memo(Mailnews22Component);
