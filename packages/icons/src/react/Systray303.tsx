...
const Systray303Component = ({
  variant = '32x32_4',
  ...rest
}: Systray303Props) => {
  const Svg = systray303Data[variant];

  return <Svg {...rest} />;
};

export const Systray303 = React.memo(Systray303Component);
