...
const Quartz201Component = ({
  variant = '32x32_4',
  ...rest
}: Quartz201Props) => {
  const Svg = quartz201Data[variant];

  return <Svg {...rest} />;
};

export const Quartz201 = React.memo(Quartz201Component);
