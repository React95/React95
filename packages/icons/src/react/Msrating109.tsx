...
const Msrating109Component = ({
  variant = '32x32_4',
  ...rest
}: Msrating109Props) => {
  const Svg = msrating109Data[variant];

  return <Svg {...rest} />;
};

export const Msrating109 = React.memo(Msrating109Component);
