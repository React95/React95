...
const Progman15Component = ({
  variant = '32x32_1',
  ...rest
}: Progman15Props) => {
  const Svg = progman15Data[variant];

  return <Svg {...rest} />;
};

export const Progman15 = React.memo(Progman15Component);
