...
const Gcdef10043Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10043Props) => {
  const Svg = gcdef10043Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10043 = React.memo(Gcdef10043Component);
