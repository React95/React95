...
const Awfxex32116Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxex32116Props) => {
  const Svg = awfxex32116Data[variant];

  return <Svg {...rest} />;
};

export const Awfxex32116 = React.memo(Awfxex32116Component);
