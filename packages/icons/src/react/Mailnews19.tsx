...
export interface Mailnews19Props extends SVGProps<SVGSVGElement> {
  /**
   * Icon variant to use.
   **/
...
const Mailnews19Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews19Props) => {
  const Svg = mailnews19Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews19 = React.memo(Mailnews19Component);
