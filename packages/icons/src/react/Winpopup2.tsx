...
const Winpopup2Component = ({
  variant = '32x32_4',
  ...rest
}: Winpopup2Props) => {
  const Svg = winpopup2Data[variant];

  return <Svg {...rest} />;
};

export const Winpopup2 = React.memo(Winpopup2Component);
