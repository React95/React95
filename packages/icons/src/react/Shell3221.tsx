...
const Shell3221Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3221Props) => {
  const Svg = shell3221Data[variant];

  return <Svg {...rest} />;
};

export const Shell3221 = React.memo(Shell3221Component);
