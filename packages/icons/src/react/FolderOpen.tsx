...
const FolderOpenComponent = ({
  variant = '32x32_4',
  ...rest
}: FolderOpenProps) => {
  const Svg = folderOpenData[variant];

  return <Svg {...rest} />;
};

export const FolderOpen = React.memo(FolderOpenComponent);
