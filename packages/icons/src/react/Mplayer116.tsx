...
const Mplayer116Component = ({
  variant = '32x32_4',
  ...rest
}: Mplayer116Props) => {
  const Svg = mplayer116Data[variant];

  return <Svg {...rest} />;
};

export const Mplayer116 = React.memo(Mplayer116Component);
