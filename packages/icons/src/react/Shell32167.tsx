...
const Shell32167Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32167Props) => {
  const Svg = shell32167Data[variant];

  return <Svg {...rest} />;
};

export const Shell32167 = React.memo(Shell32167Component);
