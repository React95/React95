...
const Url1104Component = ({
  variant = '32x32_4',
  ...rest
}: Url1104Props) => {
  const Svg = url1104Data[variant];

  return <Svg {...rest} />;
};

export const Url1104 = React.memo(Url1104Component);
