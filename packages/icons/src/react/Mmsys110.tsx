...
const Mmsys110Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys110Props) => {
  const Svg = mmsys110Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys110 = React.memo(Mmsys110Component);
