...
const Progman7Component = ({
  variant = '32x32_1',
  ...rest
}: Progman7Props) => {
  const Svg = progman7Data[variant];

  return <Svg {...rest} />;
};

export const Progman7 = React.memo(Progman7Component);
