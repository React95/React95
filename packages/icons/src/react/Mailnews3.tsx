...
const Mailnews3Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews3Props) => {
  const Svg = mailnews3Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews3 = React.memo(Mailnews3Component);
