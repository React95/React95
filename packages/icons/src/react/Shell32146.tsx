...
const Shell32146Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32146Props) => {
  const Svg = shell32146Data[variant];

  return <Svg {...rest} />;
};

export const Shell32146 = React.memo(Shell32146Component);
