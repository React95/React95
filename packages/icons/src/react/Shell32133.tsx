...
const Shell32133Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32133Props) => {
  const Svg = shell32133Data[variant];

  return <Svg {...rest} />;
};

export const Shell32133 = React.memo(Shell32133Component);
