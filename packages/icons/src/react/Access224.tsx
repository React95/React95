...
const Access224Component = ({
  variant = '32x32_4',
  ...rest
}: Access224Props) => {
  const Svg = access224Data[variant];

  return <Svg {...rest} />;
};

export const Access224 = React.memo(Access224Component);
