...
const Gcdef10044Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10044Props) => {
  const Svg = gcdef10044Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10044 = React.memo(Gcdef10044Component);
