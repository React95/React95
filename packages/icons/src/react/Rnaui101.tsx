...
const Rnaui101Component = ({
  variant = '32x32_4',
  ...rest
}: Rnaui101Props) => {
  const Svg = rnaui101Data[variant];

  return <Svg {...rest} />;
};

export const Rnaui101 = React.memo(Rnaui101Component);
