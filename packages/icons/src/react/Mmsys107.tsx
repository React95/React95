...
const Mmsys107Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys107Props) => {
  const Svg = mmsys107Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys107 = React.memo(Mmsys107Component);
