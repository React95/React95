...
const Gcdef122Component = ({
  variant = '48x48_8',
  ...rest
}: Gcdef122Props) => {
  const Svg = gcdef122Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef122 = React.memo(Gcdef122Component);
