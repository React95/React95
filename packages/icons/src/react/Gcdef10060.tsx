...
const Gcdef10060Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10060Props) => {
  const Svg = gcdef10060Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10060 = React.memo(Gcdef10060Component);
