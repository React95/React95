...
const Shell32161Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32161Props) => {
  const Svg = shell32161Data[variant];

  return <Svg {...rest} />;
};

export const Shell32161 = React.memo(Shell32161Component);
