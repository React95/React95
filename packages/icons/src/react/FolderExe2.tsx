...
const FolderExe2Component = ({
  variant = '32x32_4',
  ...rest
}: FolderExe2Props) => {
  const Svg = folderExe2Data[variant];

  return <Svg {...rest} />;
};

export const FolderExe2 = React.memo(FolderExe2Component);
