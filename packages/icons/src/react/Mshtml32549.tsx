...
const Mshtml32549Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32549Props) => {
  const Svg = mshtml32549Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32549 = React.memo(Mshtml32549Component);
