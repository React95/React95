...
const Shell32145Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32145Props) => {
  const Svg = shell32145Data[variant];

  return <Svg {...rest} />;
};

export const Shell32145 = React.memo(Shell32145Component);
