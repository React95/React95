...
const Mshtml32551Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32551Props) => {
  const Svg = mshtml32551Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32551 = React.memo(Mshtml32551Component);
