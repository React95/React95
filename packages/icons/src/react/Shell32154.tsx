...
const Shell32154Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32154Props) => {
  const Svg = shell32154Data[variant];

  return <Svg {...rest} />;
};

export const Shell32154 = React.memo(Shell32154Component);
