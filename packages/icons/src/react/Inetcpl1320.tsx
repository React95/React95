...
const Inetcpl1320Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1320Props) => {
  const Svg = inetcpl1320Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1320 = React.memo(Inetcpl1320Component);
