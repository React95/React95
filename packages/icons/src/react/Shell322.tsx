...
const Shell322Component = ({
  variant = '32x32_4',
  ...rest
}: Shell322Props) => {
  const Svg = shell322Data[variant];

  return <Svg {...rest} />;
};

export const Shell322 = React.memo(Shell322Component);
