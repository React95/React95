...
const Shdocvw259Component = ({
  variant = '32x32_4',
  ...rest
}: Shdocvw259Props) => {
  const Svg = shdocvw259Data[variant];

  return <Svg {...rest} />;
};

export const Shdocvw259 = React.memo(Shdocvw259Component);
