...
const Url104Component = ({
  variant = '32x32_4',
  ...rest
}: Url104Props) => {
  const Svg = url104Data[variant];

  return <Svg {...rest} />;
};

export const Url104 = React.memo(Url104Component);
