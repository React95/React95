...
const Awfext326049Component = ({
  variant = '32x32_4',
  ...rest
}: Awfext326049Props) => {
  const Svg = awfext326049Data[variant];

  return <Svg {...rest} />;
};

export const Awfext326049 = React.memo(Awfext326049Component);
