...
const Filexfer128Component = ({
  variant = '32x32_4',
  ...rest
}: Filexfer128Props) => {
  const Svg = filexfer128Data[variant];

  return <Svg {...rest} />;
};

export const Filexfer128 = React.memo(Filexfer128Component);
