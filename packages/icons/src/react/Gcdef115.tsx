...
const Gcdef115Component = ({
  variant = '48x48_8',
  ...rest
}: Gcdef115Props) => {
  const Svg = gcdef115Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef115 = React.memo(Gcdef115Component);
