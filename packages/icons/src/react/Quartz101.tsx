...
const Quartz101Component = ({
  variant = '32x32_4',
  ...rest
}: Quartz101Props) => {
  const Svg = quartz101Data[variant];

  return <Svg {...rest} />;
};

export const Quartz101 = React.memo(Quartz101Component);
