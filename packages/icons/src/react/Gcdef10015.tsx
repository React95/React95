...
const Gcdef10015Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10015Props) => {
  const Svg = gcdef10015Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10015 = React.memo(Gcdef10015Component);
