...
export interface Systray302Props extends SVGProps<SVGSVGElement> {
  /**
   * Icon variant to use.
   **/
...
const Systray302Component = ({
  variant = '32x32_4',
  ...rest
}: Systray302Props) => {
  const Svg = systray302Data[variant];

  return <Svg {...rest} />;
};

export const Systray302 = React.memo(Systray302Component);
