...
const Progman22Component = ({
  variant = '32x32_1',
  ...rest
}: Progman22Props) => {
  const Svg = progman22Data[variant];

  return <Svg {...rest} />;
};

export const Progman22 = React.memo(Progman22Component);
