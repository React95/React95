...
const Fontext2Component = ({
  variant = '32x32_4',
  ...rest
}: Fontext2Props) => {
  const Svg = fontext2Data[variant];

  return <Svg {...rest} />;
};

export const Fontext2 = React.memo(Fontext2Component);
