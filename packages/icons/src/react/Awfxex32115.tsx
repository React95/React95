...
const Awfxex32115Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxex32115Props) => {
  const Svg = awfxex32115Data[variant];

  return <Svg {...rest} />;
};

export const Awfxex32115 = React.memo(Awfxex32115Component);
