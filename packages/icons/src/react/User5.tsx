...
const User5Component = ({
  variant = '32x32_1',
  ...rest
}: User5Props) => {
  const Svg = user5Data[variant];

  return <Svg {...rest} />;
};

export const User5 = React.memo(User5Component);
