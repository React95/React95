...
const Shell32156Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32156Props) => {
  const Svg = shell32156Data[variant];

  return <Svg {...rest} />;
};

export const Shell32156 = React.memo(Shell32156Component);
