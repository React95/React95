...
const Notepad2Component = ({
  variant = '32x32_4',
  ...rest
}: Notepad2Props) => {
  const Svg = notepad2Data[variant];

  return <Svg {...rest} />;
};

export const Notepad2 = React.memo(Notepad2Component);
