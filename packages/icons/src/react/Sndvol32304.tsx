...
const Sndvol32304Component = ({
  variant = '32x32_4',
  ...rest
}: Sndvol32304Props) => {
  const Svg = sndvol32304Data[variant];

  return <Svg {...rest} />;
};

export const Sndvol32304 = React.memo(Sndvol32304Component);
