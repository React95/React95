...
const Mplayer12Component = ({
  variant = '32x32_4',
  ...rest
}: Mplayer12Props) => {
  const Svg = mplayer12Data[variant];

  return <Svg {...rest} />;
};

export const Mplayer12 = React.memo(Mplayer12Component);
