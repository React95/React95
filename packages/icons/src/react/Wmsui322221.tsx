...
const Wmsui322221Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui322221Props) => {
  const Svg = wmsui322221Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui322221 = React.memo(Wmsui322221Component);
