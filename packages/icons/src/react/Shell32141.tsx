...
const Shell32141Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32141Props) => {
  const Svg = shell32141Data[variant];

  return <Svg {...rest} />;
};

export const Shell32141 = React.memo(Shell32141Component);
