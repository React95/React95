...
const Nwnp32FolderIconComponent = ({
  variant = '32x32_4',
  ...rest
}: Nwnp32FolderIconProps) => {
  const Svg = nwnp32FolderIconData[variant];

  return <Svg {...rest} />;
};

export const Nwnp32FolderIcon = React.memo(Nwnp32FolderIconComponent);
