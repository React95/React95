...
const Awschd32400Component = ({
  variant = '32x32_4',
  ...rest
}: Awschd32400Props) => {
  const Svg = awschd32400Data[variant];

  return <Svg {...rest} />;
};

export const Awschd32400 = React.memo(Awschd32400Component);
