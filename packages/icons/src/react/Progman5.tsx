...
const Progman5Component = ({
  variant = '32x32_1',
  ...rest
}: Progman5Props) => {
  const Svg = progman5Data[variant];

  return <Svg {...rest} />;
};

export const Progman5 = React.memo(Progman5Component);
