...
const Wmsui323912Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui323912Props) => {
  const Svg = wmsui323912Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui323912 = React.memo(Wmsui323912Component);
