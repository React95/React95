...
const Gcdef10005Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10005Props) => {
  const Svg = gcdef10005Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10005 = React.memo(Gcdef10005Component);
