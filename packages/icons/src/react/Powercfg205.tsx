...
const Powercfg205Component = ({
  variant = '32x32_4',
  ...rest
}: Powercfg205Props) => {
  const Svg = powercfg205Data[variant];

  return <Svg {...rest} />;
};

export const Powercfg205 = React.memo(Powercfg205Component);
