...
const Rnaapp100Component = ({
  variant = '32x32_4',
  ...rest
}: Rnaapp100Props) => {
  const Svg = rnaapp100Data[variant];

  return <Svg {...rest} />;
};

export const Rnaapp100 = React.memo(Rnaapp100Component);
