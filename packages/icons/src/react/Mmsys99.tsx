...
const Mmsys99Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys99Props) => {
  const Svg = mmsys99Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys99 = React.memo(Mmsys99Component);
