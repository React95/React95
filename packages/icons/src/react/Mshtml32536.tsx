...
const Mshtml32536Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32536Props) => {
  const Svg = mshtml32536Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32536 = React.memo(Mshtml32536Component);
