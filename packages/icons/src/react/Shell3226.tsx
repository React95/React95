...
const Shell3226Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3226Props) => {
  const Svg = shell3226Data[variant];

  return <Svg {...rest} />;
};

export const Shell3226 = React.memo(Shell3226Component);
