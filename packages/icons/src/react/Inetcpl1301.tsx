...
const Inetcpl1301Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1301Props) => {
  const Svg = inetcpl1301Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1301 = React.memo(Inetcpl1301Component);
