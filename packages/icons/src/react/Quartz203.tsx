...
const Quartz203Component = ({
  variant = '32x32_4',
  ...rest
}: Quartz203Props) => {
  const Svg = quartz203Data[variant];

  return <Svg {...rest} />;
};

export const Quartz203 = React.memo(Quartz203Component);
