...
const Wangimg129Component = ({
  variant = '32x32_4',
  ...rest
}: Wangimg129Props) => {
  const Svg = wangimg129Data[variant];

  return <Svg {...rest} />;
};

export const Wangimg129 = React.memo(Wangimg129Component);
