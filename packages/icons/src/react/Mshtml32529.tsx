...
const Mshtml32529Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32529Props) => {
  const Svg = mshtml32529Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32529 = React.memo(Mshtml32529Component);
