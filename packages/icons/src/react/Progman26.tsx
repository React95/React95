...
const Progman26Component = ({
  variant = '32x32_1',
  ...rest
}: Progman26Props) => {
  const Svg = progman26Data[variant];

  return <Svg {...rest} />;
};

export const Progman26 = React.memo(Progman26Component);
