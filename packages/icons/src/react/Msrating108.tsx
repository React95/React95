...
const Msrating108Component = ({
  variant = '32x32_4',
  ...rest
}: Msrating108Props) => {
  const Svg = msrating108Data[variant];

  return <Svg {...rest} />;
};

export const Msrating108 = React.memo(Msrating108Component);
