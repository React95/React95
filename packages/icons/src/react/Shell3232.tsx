...
const Shell3232Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3232Props) => {
  const Svg = shell3232Data[variant];

  return <Svg {...rest} />;
};

export const Shell3232 = React.memo(Shell3232Component);
