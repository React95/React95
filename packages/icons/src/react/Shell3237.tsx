...
const Shell3237Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3237Props) => {
  const Svg = shell3237Data[variant];

  return <Svg {...rest} />;
};

export const Shell3237 = React.memo(Shell3237Component);
