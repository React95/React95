...
const Isign32IcoAppComponent = ({
  variant = '32x32_4',
  ...rest
}: Isign32IcoAppProps) => {
  const Svg = isign32IcoAppData[variant];

  return <Svg {...rest} />;
};

export const Isign32IcoApp = React.memo(Isign32IcoAppComponent);
