...
const Mcm3202Component = ({
  variant = '32x32_4',
  ...rest
}: Mcm3202Props) => {
  const Svg = mcm3202Data[variant];

  return <Svg {...rest} />;
};

export const Mcm3202 = React.memo(Mcm3202Component);
