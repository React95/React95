...
const Gcdef10047Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10047Props) => {
  const Svg = gcdef10047Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10047 = React.memo(Gcdef10047Component);
