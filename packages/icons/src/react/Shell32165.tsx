...
const Shell32165Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32165Props) => {
  const Svg = shell32165Data[variant];

  return <Svg {...rest} />;
};

export const Shell32165 = React.memo(Shell32165Component);
