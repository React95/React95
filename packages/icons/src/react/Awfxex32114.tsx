...
const Awfxex32114Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxex32114Props) => {
  const Svg = awfxex32114Data[variant];

  return <Svg {...rest} />;
};

export const Awfxex32114 = React.memo(Awfxex32114Component);
