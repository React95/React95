...
const Rasapi32100Component = ({
  variant = '32x32_4',
  ...rest
}: Rasapi32100Props) => {
  const Svg = rasapi32100Data[variant];

  return <Svg {...rest} />;
};

export const Rasapi32100 = React.memo(Rasapi32100Component);
