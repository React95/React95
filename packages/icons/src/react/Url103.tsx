...
const Url103Component = ({
  variant = '32x32_4',
  ...rest
}: Url103Props) => {
  const Svg = url103Data[variant];

  return <Svg {...rest} />;
};

export const Url103 = React.memo(Url103Component);
