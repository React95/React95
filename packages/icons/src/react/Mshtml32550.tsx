...
const Mshtml32550Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32550Props) => {
  const Svg = mshtml32550Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32550 = React.memo(Mshtml32550Component);
