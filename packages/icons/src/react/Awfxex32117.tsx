...
const Awfxex32117Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxex32117Props) => {
  const Svg = awfxex32117Data[variant];

  return <Svg {...rest} />;
};

export const Awfxex32117 = React.memo(Awfxex32117Component);
