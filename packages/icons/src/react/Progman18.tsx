...
const Progman18Component = ({
  variant = '32x32_1',
  ...rest
}: Progman18Props) => {
  const Svg = progman18Data[variant];

  return <Svg {...rest} />;
};

export const Progman18 = React.memo(Progman18Component);
