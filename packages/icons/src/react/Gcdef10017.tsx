...
const Gcdef10017Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10017Props) => {
  const Svg = gcdef10017Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10017 = React.memo(Gcdef10017Component);
