...
const Confcp1100Component = ({
  variant = '32x32_4',
  ...rest
}: Confcp1100Props) => {
  const Svg = confcp1100Data[variant];

  return <Svg {...rest} />;
};

export const Confcp1100 = React.memo(Confcp1100Component);
