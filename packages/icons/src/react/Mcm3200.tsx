...
const Mcm3200Component = ({
  variant = '32x32_4',
  ...rest
}: Mcm3200Props) => {
  const Svg = mcm3200Data[variant];

  return <Svg {...rest} />;
};

export const Mcm3200 = React.memo(Mcm3200Component);
