...
const Winfile2Component = ({
  variant = '32x32_1',
  ...rest
}: Winfile2Props) => {
  const Svg = winfile2Data[variant];

  return <Svg {...rest} />;
};

export const Winfile2 = React.memo(Winfile2Component);
