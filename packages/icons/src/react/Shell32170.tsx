...
const Shell32170Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32170Props) => {
  const Svg = shell32170Data[variant];

  return <Svg {...rest} />;
};

export const Shell32170 = React.memo(Shell32170Component);
