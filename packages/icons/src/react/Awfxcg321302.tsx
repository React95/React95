...
const Awfxcg321302Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxcg321302Props) => {
  const Svg = awfxcg321302Data[variant];

  return <Svg {...rest} />;
};

export const Awfxcg321302 = React.memo(Awfxcg321302Component);
