...
const Wmsui323926Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui323926Props) => {
  const Svg = wmsui323926Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui323926 = React.memo(Wmsui323926Component);
