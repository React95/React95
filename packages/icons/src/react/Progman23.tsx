...
const Progman23Component = ({
  variant = '32x32_1',
  ...rest
}: Progman23Props) => {
  const Svg = progman23Data[variant];

  return <Svg {...rest} />;
};

export const Progman23 = React.memo(Progman23Component);
