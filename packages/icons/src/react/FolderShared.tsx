...
const FolderSharedComponent = ({
  variant = '32x32_4',
  ...rest
}: FolderSharedProps) => {
  const Svg = folderSharedData[variant];

  return <Svg {...rest} />;
};

export const FolderShared = React.memo(FolderSharedComponent);
