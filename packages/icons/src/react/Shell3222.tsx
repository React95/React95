...
const Shell3222Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3222Props) => {
  const Svg = shell3222Data[variant];

  return <Svg {...rest} />;
};

export const Shell3222 = React.memo(Shell3222Component);
