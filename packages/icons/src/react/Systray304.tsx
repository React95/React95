...
const Systray304Component = ({
  variant = '32x32_4',
  ...rest
}: Systray304Props) => {
  const Svg = systray304Data[variant];

  return <Svg {...rest} />;
};

export const Systray304 = React.memo(Systray304Component);
