...
const Rnaui102Component = ({
  variant = '32x32_4',
  ...rest
}: Rnaui102Props) => {
  const Svg = rnaui102Data[variant];

  return <Svg {...rest} />;
};

export const Rnaui102 = React.memo(Rnaui102Component);
