...
const Filexfer129Component = ({
  variant = '32x32_4',
  ...rest
}: Filexfer129Props) => {
  const Svg = filexfer129Data[variant];

  return <Svg {...rest} />;
};

export const Filexfer129 = React.memo(Filexfer129Component);
