...
export interface Wmsui323911Props extends SVGProps<SVGSVGElement> {
  /**
   * Icon variant to use.
   **/
...
const Wmsui323911Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui323911Props) => {
  const Svg = wmsui323911Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui323911 = React.memo(Wmsui323911Component);
