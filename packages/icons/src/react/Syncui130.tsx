...
const Syncui130Component = ({
  variant = '32x32_4',
  ...rest
}: Syncui130Props) => {
  const Svg = syncui130Data[variant];

  return <Svg {...rest} />;
};

export const Syncui130 = React.memo(Syncui130Component);
