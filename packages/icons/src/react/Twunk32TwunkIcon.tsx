...
const Twunk32TwunkIconComponent = ({
  variant = '32x32_4',
  ...rest
}: Twunk32TwunkIconProps) => {
  const Svg = twunk32TwunkIconData[variant];

  return <Svg {...rest} />;
};

export const Twunk32TwunkIcon = React.memo(Twunk32TwunkIconComponent);
