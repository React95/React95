...
const Syncui123Component = ({
  variant = '32x32_4',
  ...rest
}: Syncui123Props) => {
  const Svg = syncui123Data[variant];

  return <Svg {...rest} />;
};

export const Syncui123 = React.memo(Syncui123Component);
