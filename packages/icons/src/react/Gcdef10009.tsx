...
const Gcdef10009Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10009Props) => {
  const Svg = gcdef10009Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10009 = React.memo(Gcdef10009Component);
