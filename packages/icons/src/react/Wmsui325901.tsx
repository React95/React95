...
const Wmsui325901Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui325901Props) => {
  const Svg = wmsui325901Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui325901 = React.memo(Wmsui325901Component);
