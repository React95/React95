...
const Mmsys102Component = ({
  variant = '32x32_1',
  ...rest
}: Mmsys102Props) => {
  const Svg = mmsys102Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys102 = React.memo(Mmsys102Component);
