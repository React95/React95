...
const Mplayer113Component = ({
  variant = '32x32_4',
  ...rest
}: Mplayer113Props) => {
  const Svg = mplayer113Data[variant];

  return <Svg {...rest} />;
};

export const Mplayer113 = React.memo(Mplayer113Component);
