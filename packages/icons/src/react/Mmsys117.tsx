...
const Mmsys117Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys117Props) => {
  const Svg = mmsys117Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys117 = React.memo(Mmsys117Component);
