...
const Shell3219Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3219Props) => {
  const Svg = shell3219Data[variant];

  return <Svg {...rest} />;
};

export const Shell3219 = React.memo(Shell3219Component);
