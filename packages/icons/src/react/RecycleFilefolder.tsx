...
const RecycleFilefolderComponent = ({
  variant = '32x32_4',
  ...rest
}: RecycleFilefolderProps) => {
  const Svg = recycleFilefolderData[variant];

  return <Svg {...rest} />;
};

export const RecycleFilefolder = React.memo(RecycleFilefolderComponent);
