...
const Computer3Component = ({
  variant = '32x32_4',
  ...rest
}: Computer3Props) => {
  const Svg = computer3Data[variant];

  return <Svg {...rest} />;
};

export const Computer3 = React.memo(Computer3Component);
