...
const Winfile3Component = ({
  variant = '32x32_1',
  ...rest
}: Winfile3Props) => {
  const Svg = winfile3Data[variant];

  return <Svg {...rest} />;
};

export const Winfile3 = React.memo(Winfile3Component);
