...
const Shell325Component = ({
  variant = '32x32_4',
  ...rest
}: Shell325Props) => {
  const Svg = shell325Data[variant];

  return <Svg {...rest} />;
};

export const Shell325 = React.memo(Shell325Component);
