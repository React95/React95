...
const Awfxcg321303Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxcg321303Props) => {
  const Svg = awfxcg321303Data[variant];

  return <Svg {...rest} />;
};

export const Awfxcg321303 = React.memo(Awfxcg321303Component);
