...
const Mplayer16Component = ({
  variant = '32x32_4',
  ...rest
}: Mplayer16Props) => {
  const Svg = mplayer16Data[variant];

  return <Svg {...rest} />;
};

export const Mplayer16 = React.memo(Mplayer16Component);
