...
const Shell32166Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32166Props) => {
  const Svg = shell32166Data[variant];

  return <Svg {...rest} />;
};

export const Shell32166 = React.memo(Shell32166Component);
