...
const Gcdef116Component = ({
  variant = '48x48_8',
  ...rest
}: Gcdef116Props) => {
  const Svg = gcdef116Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef116 = React.memo(Gcdef116Component);
