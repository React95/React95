...
const Wmsui325900Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui325900Props) => {
  const Svg = wmsui325900Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui325900 = React.memo(Wmsui325900Component);
