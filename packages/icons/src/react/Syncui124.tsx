...
const Syncui124Component = ({
  variant = '32x32_4',
  ...rest
}: Syncui124Props) => {
  const Svg = syncui124Data[variant];

  return <Svg {...rest} />;
};

export const Syncui124 = React.memo(Syncui124Component);
