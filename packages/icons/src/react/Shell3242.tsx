...
const Shell3242Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3242Props) => {
  const Svg = shell3242Data[variant];

  return <Svg {...rest} />;
};

export const Shell3242 = React.memo(Shell3242Component);
