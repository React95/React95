...
const Gcdef10034Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10034Props) => {
  const Svg = gcdef10034Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10034 = React.memo(Gcdef10034Component);
