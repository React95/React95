...
const Progman25Component = ({
  variant = '32x32_1',
  ...rest
}: Progman25Props) => {
  const Svg = progman25Data[variant];

  return <Svg {...rest} />;
};

export const Progman25 = React.memo(Progman25Component);
