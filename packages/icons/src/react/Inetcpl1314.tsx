...
const Inetcpl1314Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1314Props) => {
  const Svg = inetcpl1314Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1314 = React.memo(Inetcpl1314Component);
