...
const Sndvol32300Component = ({
  variant = '32x32_4',
  ...rest
}: Sndvol32300Props) => {
  const Svg = sndvol32300Data[variant];

  return <Svg {...rest} />;
};

export const Sndvol32300 = React.memo(Sndvol32300Component);
