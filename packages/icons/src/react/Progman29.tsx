...
const Progman29Component = ({
  variant = '32x32_1',
  ...rest
}: Progman29Props) => {
  const Svg = progman29Data[variant];

  return <Svg {...rest} />;
};

export const Progman29 = React.memo(Progman29Component);
