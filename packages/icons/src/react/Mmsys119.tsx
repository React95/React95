...
const Mmsys119Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys119Props) => {
  const Svg = mmsys119Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys119 = React.memo(Mmsys119Component);
