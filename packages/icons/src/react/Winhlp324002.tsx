...
const Winhlp324002Component = ({
  variant = '32x32_4',
  ...rest
}: Winhlp324002Props) => {
  const Svg = winhlp324002Data[variant];

  return <Svg {...rest} />;
};

export const Winhlp324002 = React.memo(Winhlp324002Component);
