...
const Shell3214Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3214Props) => {
  const Svg = shell3214Data[variant];

  return <Svg {...rest} />;
};

export const Shell3214 = React.memo(Shell3214Component);
