...
const User4Component = ({
  variant = '32x32_1',
  ...rest
}: User4Props) => {
  const Svg = user4Data[variant];

  return <Svg {...rest} />;
};

export const User4 = React.memo(User4Component);
