...
const Mailnews16Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews16Props) => {
  const Svg = mailnews16Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews16 = React.memo(Mailnews16Component);
