...
const Shell32143Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32143Props) => {
  const Svg = shell32143Data[variant];

  return <Svg {...rest} />;
};

export const Shell32143 = React.memo(Shell32143Component);
