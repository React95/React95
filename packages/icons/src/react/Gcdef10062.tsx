...
const Gcdef10062Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10062Props) => {
  const Svg = gcdef10062Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10062 = React.memo(Gcdef10062Component);
