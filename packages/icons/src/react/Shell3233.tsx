...
const Shell3233Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3233Props) => {
  const Svg = shell3233Data[variant];

  return <Svg {...rest} />;
};

export const Shell3233 = React.memo(Shell3233Component);
