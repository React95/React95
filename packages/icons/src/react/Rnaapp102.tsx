...
const Rnaapp102Component = ({
  variant = '32x32_4',
  ...rest
}: Rnaapp102Props) => {
  const Svg = rnaapp102Data[variant];

  return <Svg {...rest} />;
};

export const Rnaapp102 = React.memo(Rnaapp102Component);
