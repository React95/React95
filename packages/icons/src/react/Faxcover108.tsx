...
const Faxcover108Component = ({
  variant = '32x32_4',
  ...rest
}: Faxcover108Props) => {
  const Svg = faxcover108Data[variant];

  return <Svg {...rest} />;
};

export const Faxcover108 = React.memo(Faxcover108Component);
