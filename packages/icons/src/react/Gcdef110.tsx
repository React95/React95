...
const Gcdef110Component = ({
  variant = '48x48_8',
  ...rest
}: Gcdef110Props) => {
  const Svg = gcdef110Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef110 = React.memo(Gcdef110Component);
