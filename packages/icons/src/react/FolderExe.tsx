...
const FolderExeComponent = ({
  variant = '32x32_4',
  ...rest
}: FolderExeProps) => {
  const Svg = folderExeData[variant];

  return <Svg {...rest} />;
};

export const FolderExe = React.memo(FolderExeComponent);
