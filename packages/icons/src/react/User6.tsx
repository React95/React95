...
const User6Component = ({
  variant = '32x32_1',
  ...rest
}: User6Props) => {
  const Svg = user6Data[variant];

  return <Svg {...rest} />;
};

export const User6 = React.memo(User6Component);
