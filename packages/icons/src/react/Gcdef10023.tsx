...
const Gcdef10023Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10023Props) => {
  const Svg = gcdef10023Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10023 = React.memo(Gcdef10023Component);
