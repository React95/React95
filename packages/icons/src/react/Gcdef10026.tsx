...
const Gcdef10026Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10026Props) => {
  const Svg = gcdef10026Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10026 = React.memo(Gcdef10026Component);
