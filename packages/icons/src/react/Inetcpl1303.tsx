...
const Inetcpl1303Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1303Props) => {
  const Svg = inetcpl1303Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1303 = React.memo(Inetcpl1303Component);
