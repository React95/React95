...
const Inetcpl1305Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1305Props) => {
  const Svg = inetcpl1305Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1305 = React.memo(Inetcpl1305Component);
