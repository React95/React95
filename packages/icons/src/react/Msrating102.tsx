...
const Msrating102Component = ({
  variant = '32x32_4',
  ...rest
}: Msrating102Props) => {
  const Svg = msrating102Data[variant];

  return <Svg {...rest} />;
};

export const Msrating102 = React.memo(Msrating102Component);
