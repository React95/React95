...
const Awfxcg321304Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxcg321304Props) => {
  const Svg = awfxcg321304Data[variant];

  return <Svg {...rest} />;
};

export const Awfxcg321304 = React.memo(Awfxcg321304Component);
