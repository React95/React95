...
const Mshtml32538Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32538Props) => {
  const Svg = mshtml32538Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32538 = React.memo(Mshtml32538Component);
