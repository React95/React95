...
const Main300Component = ({
  variant = '32x32_4',
  ...rest
}: Main300Props) => {
  const Svg = main300Data[variant];

  return <Svg {...rest} />;
};

export const Main300 = React.memo(Main300Component);
