...
const Rnaui103Component = ({
  variant = '32x32_4',
  ...rest
}: Rnaui103Props) => {
  const Svg = rnaui103Data[variant];

  return <Svg {...rest} />;
};

export const Rnaui103 = React.memo(Rnaui103Component);
