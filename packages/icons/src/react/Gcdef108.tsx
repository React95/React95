...
const Gcdef108Component = ({
  variant = '48x48_8',
  ...rest
}: Gcdef108Props) => {
  const Svg = gcdef108Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef108 = React.memo(Gcdef108Component);
