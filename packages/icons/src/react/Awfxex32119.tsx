...
const Awfxex32119Component = ({
  variant = '32x32_4',
  ...rest
}: Awfxex32119Props) => {
  const Svg = awfxex32119Data[variant];

  return <Svg {...rest} />;
};

export const Awfxex32119 = React.memo(Awfxex32119Component);
