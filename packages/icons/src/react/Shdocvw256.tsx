...
const Shdocvw256Component = ({
  variant = '32x32_4',
  ...rest
}: Shdocvw256Props) => {
  const Svg = shdocvw256Data[variant];

  return <Svg {...rest} />;
};

export const Shdocvw256 = React.memo(Shdocvw256Component);
