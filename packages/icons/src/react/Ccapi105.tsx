...
const Ccapi105Component = ({
  variant = '32x32_4',
  ...rest
}: Ccapi105Props) => {
  const Svg = ccapi105Data[variant];

  return <Svg {...rest} />;
};

export const Ccapi105 = React.memo(Ccapi105Component);
