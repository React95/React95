...
const Shell3224Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3224Props) => {
  const Svg = shell3224Data[variant];

  return <Svg {...rest} />;
};

export const Shell3224 = React.memo(Shell3224Component);
