...
const Computer2Component = ({
  variant = '32x32_4',
  ...rest
}: Computer2Props) => {
  const Svg = computer2Data[variant];

  return <Svg {...rest} />;
};

export const Computer2 = React.memo(Computer2Component);
