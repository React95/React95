...
const Progman9Component = ({
  variant = '32x32_1',
  ...rest
}: Progman9Props) => {
  const Svg = progman9Data[variant];

  return <Svg {...rest} />;
};

export const Progman9 = React.memo(Progman9Component);
