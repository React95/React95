...
const Explorer103Component = ({
  variant = '32x32_4',
  ...rest
}: Explorer103Props) => {
  const Svg = explorer103Data[variant];

  return <Svg {...rest} />;
};

export const Explorer103 = React.memo(Explorer103Component);
