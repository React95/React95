...
const Progman16Component = ({
  variant = '32x32_1',
  ...rest
}: Progman16Props) => {
  const Svg = progman16Data[variant];

  return <Svg {...rest} />;
};

export const Progman16 = React.memo(Progman16Component);
