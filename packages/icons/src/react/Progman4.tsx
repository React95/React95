...
const Progman4Component = ({
  variant = '32x32_1',
  ...rest
}: Progman4Props) => {
  const Svg = progman4Data[variant];

  return <Svg {...rest} />;
};

export const Progman4 = React.memo(Progman4Component);
