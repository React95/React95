...
const Conflnk103Component = ({
  variant = '32x32_4',
  ...rest
}: Conflnk103Props) => {
  const Svg = conflnk103Data[variant];

  return <Svg {...rest} />;
};

export const Conflnk103 = React.memo(Conflnk103Component);
