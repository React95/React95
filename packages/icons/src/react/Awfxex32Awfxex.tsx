...
const Awfxex32AwfxexComponent = ({
  variant = '32x32_4',
  ...rest
}: Awfxex32AwfxexProps) => {
  const Svg = awfxex32AwfxexData[variant];

  return <Svg {...rest} />;
};

export const Awfxex32Awfxex = React.memo(Awfxex32AwfxexComponent);
