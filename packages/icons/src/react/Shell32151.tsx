...
const Shell32151Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32151Props) => {
  const Svg = shell32151Data[variant];

  return <Svg {...rest} />;
};

export const Shell32151 = React.memo(Shell32151Component);
