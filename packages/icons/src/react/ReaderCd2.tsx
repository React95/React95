...
const ReaderCd2Component = ({
  variant = '32x32_4',
  ...rest
}: ReaderCd2Props) => {
  const Svg = readerCd2Data[variant];

  return <Svg {...rest} />;
};

export const ReaderCd2 = React.memo(ReaderCd2Component);
