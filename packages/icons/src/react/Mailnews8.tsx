...
const Mailnews8Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews8Props) => {
  const Svg = mailnews8Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews8 = React.memo(Mailnews8Component);
