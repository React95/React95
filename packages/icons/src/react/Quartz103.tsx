...
const Quartz103Component = ({
  variant = '32x32_4',
  ...rest
}: Quartz103Props) => {
  const Svg = quartz103Data[variant];

  return <Svg {...rest} />;
};

export const Quartz103 = React.memo(Quartz103Component);
