...
const Rnaui104Component = ({
  variant = '32x32_4',
  ...rest
}: Rnaui104Props) => {
  const Svg = rnaui104Data[variant];

  return <Svg {...rest} />;
};

export const Rnaui104 = React.memo(Rnaui104Component);
