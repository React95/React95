...
const Nwnp32WrkgrpIconComponent = ({
  variant = '32x32_4',
  ...rest
}: Nwnp32WrkgrpIconProps) => {
  const Svg = nwnp32WrkgrpIconData[variant];

  return <Svg {...rest} />;
};

export const Nwnp32WrkgrpIcon = React.memo(Nwnp32WrkgrpIconComponent);
