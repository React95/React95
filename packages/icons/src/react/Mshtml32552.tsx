...
const Mshtml32552Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32552Props) => {
  const Svg = mshtml32552Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32552 = React.memo(Mshtml32552Component);
