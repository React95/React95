...
const Progman21Component = ({
  variant = '32x32_1',
  ...rest
}: Progman21Props) => {
  const Svg = progman21Data[variant];

  return <Svg {...rest} />;
};

export const Progman21 = React.memo(Progman21Component);
