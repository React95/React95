...
const Syncui135Component = ({
  variant = '32x32_4',
  ...rest
}: Syncui135Props) => {
  const Svg = syncui135Data[variant];

  return <Svg {...rest} />;
};

export const Syncui135 = React.memo(Syncui135Component);
