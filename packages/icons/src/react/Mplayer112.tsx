...
const Mplayer112Component = ({
  variant = '32x32_4',
  ...rest
}: Mplayer112Props) => {
  const Svg = mplayer112Data[variant];

  return <Svg {...rest} />;
};

export const Mplayer112 = React.memo(Mplayer112Component);
