...
const Shell3231Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3231Props) => {
  const Svg = shell3231Data[variant];

  return <Svg {...rest} />;
};

export const Shell3231 = React.memo(Shell3231Component);
