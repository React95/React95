...
const Inetcpl1312Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1312Props) => {
  const Svg = inetcpl1312Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1312 = React.memo(Inetcpl1312Component);
