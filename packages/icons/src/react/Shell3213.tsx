...
const Shell3213Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3213Props) => {
  const Svg = shell3213Data[variant];

  return <Svg {...rest} />;
};

export const Shell3213 = React.memo(Shell3213Component);
