...
const Mshtml32540Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32540Props) => {
  const Svg = mshtml32540Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32540 = React.memo(Mshtml32540Component);
