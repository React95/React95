...
const PackagerComponent = ({
  variant = '32x32_1',
  ...rest
}: PackagerProps) => {
  const Svg = packagerData[variant];

  return <Svg {...rest} />;
};

export const Packager = React.memo(PackagerComponent);
