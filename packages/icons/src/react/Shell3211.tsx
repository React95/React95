...
const Shell3211Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3211Props) => {
  const Svg = shell3211Data[variant];

  return <Svg {...rest} />;
};

export const Shell3211 = React.memo(Shell3211Component);
