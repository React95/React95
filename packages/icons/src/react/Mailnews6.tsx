...
const Mailnews6Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews6Props) => {
  const Svg = mailnews6Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews6 = React.memo(Mailnews6Component);
