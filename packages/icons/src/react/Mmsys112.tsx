...
const Mmsys112Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys112Props) => {
  const Svg = mmsys112Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys112 = React.memo(Mmsys112Component);
