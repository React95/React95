...
const Progman12Component = ({
  variant = '32x32_1',
  ...rest
}: Progman12Props) => {
  const Svg = progman12Data[variant];

  return <Svg {...rest} />;
};

export const Progman12 = React.memo(Progman12Component);
