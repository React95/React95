...
const Progman19Component = ({
  variant = '32x32_1',
  ...rest
}: Progman19Props) => {
  const Svg = progman19Data[variant];

  return <Svg {...rest} />;
};

export const Progman19 = React.memo(Progman19Component);
