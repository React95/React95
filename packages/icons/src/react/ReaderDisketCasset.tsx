...
const ReaderDisketCassetComponent = ({
  variant = '32x32_4',
  ...rest
}: ReaderDisketCassetProps) => {
  const Svg = readerDisketCassetData[variant];

  return <Svg {...rest} />;
};

export const ReaderDisketCasset = React.memo(ReaderDisketCassetComponent);
