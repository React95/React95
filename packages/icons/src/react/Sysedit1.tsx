...
const Sysedit1Component = ({
  variant = '32x32_4',
  ...rest
}: Sysedit1Props) => {
  const Svg = sysedit1Data[variant];

  return <Svg {...rest} />;
};

export const Sysedit1 = React.memo(Sysedit1Component);
