...
const Mplayer114Component = ({
  variant = '32x32_4',
  ...rest
}: Mplayer114Props) => {
  const Svg = mplayer114Data[variant];

  return <Svg {...rest} />;
};

export const Mplayer114 = React.memo(Mplayer114Component);
