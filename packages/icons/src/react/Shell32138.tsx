...
const Shell32138Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32138Props) => {
  const Svg = shell32138Data[variant];

  return <Svg {...rest} />;
};

export const Shell32138 = React.memo(Shell32138Component);
