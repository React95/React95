...
const Rasapi32103Component = ({
  variant = '32x32_4',
  ...rest
}: Rasapi32103Props) => {
  const Svg = rasapi32103Data[variant];

  return <Svg {...rest} />;
};

export const Rasapi32103 = React.memo(Rasapi32103Component);
