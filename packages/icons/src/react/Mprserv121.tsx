...
const Mprserv121Component = ({
  variant = '48x48_4',
  ...rest
}: Mprserv121Props) => {
  const Svg = mprserv121Data[variant];

  return <Svg {...rest} />;
};

export const Mprserv121 = React.memo(Mprserv121Component);
