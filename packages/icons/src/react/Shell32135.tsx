...
const Shell32135Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32135Props) => {
  const Svg = shell32135Data[variant];

  return <Svg {...rest} />;
};

export const Shell32135 = React.memo(Shell32135Component);
