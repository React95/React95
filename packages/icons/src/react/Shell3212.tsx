...
const Shell3212Component = ({
  variant = '32x32_4',
  ...rest
}: Shell3212Props) => {
  const Svg = shell3212Data[variant];

  return <Svg {...rest} />;
};

export const Shell3212 = React.memo(Shell3212Component);
