...
const Wmsui323920Component = ({
  variant = '32x32_4',
  ...rest
}: Wmsui323920Props) => {
  const Svg = wmsui323920Data[variant];

  return <Svg {...rest} />;
};

export const Wmsui323920 = React.memo(Wmsui323920Component);
