...
const Explorer107Component = ({
  variant = '32x32_4',
  ...rest
}: Explorer107Props) => {
  const Svg = explorer107Data[variant];

  return <Svg {...rest} />;
};

export const Explorer107 = React.memo(Explorer107Component);
