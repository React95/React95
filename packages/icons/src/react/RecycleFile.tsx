...
const RecycleFileComponent = ({
  variant = '32x32_4',
  ...rest
}: RecycleFileProps) => {
  const Svg = recycleFileData[variant];

  return <Svg {...rest} />;
};

export const RecycleFile = React.memo(RecycleFileComponent);
