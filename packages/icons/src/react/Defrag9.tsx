...
const Defrag9Component = ({
  variant = '32x32_4',
  ...rest
}: Defrag9Props) => {
  const Svg = defrag9Data[variant];

  return <Svg {...rest} />;
};

export const Defrag9 = React.memo(Defrag9Component);
