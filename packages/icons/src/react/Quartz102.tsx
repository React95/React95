...
const Quartz102Component = ({
  variant = '32x32_4',
  ...rest
}: Quartz102Props) => {
  const Svg = quartz102Data[variant];

  return <Svg {...rest} />;
};

export const Quartz102 = React.memo(Quartz102Component);
