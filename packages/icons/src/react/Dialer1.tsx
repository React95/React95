...
const Dialer1Component = ({
  variant = '32x32_4',
  ...rest
}: Dialer1Props) => {
  const Svg = dialer1Data[variant];

  return <Svg {...rest} />;
};

export const Dialer1 = React.memo(Dialer1Component);
