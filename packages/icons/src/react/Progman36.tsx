...
const Progman36Component = ({
  variant = '32x32_1',
  ...rest
}: Progman36Props) => {
  const Svg = progman36Data[variant];

  return <Svg {...rest} />;
};

export const Progman36 = React.memo(Progman36Component);
