...
const DefragComponent = ({
  variant = '32x32_4',
  ...rest
}: DefragProps) => {
  const Svg = defragData[variant];

  return <Svg {...rest} />;
};

export const Defrag = React.memo(DefragComponent);
