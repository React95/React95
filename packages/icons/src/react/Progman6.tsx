...
const Progman6Component = ({
  variant = '32x32_1',
  ...rest
}: Progman6Props) => {
  const Svg = progman6Data[variant];

  return <Svg {...rest} />;
};

export const Progman6 = React.memo(Progman6Component);
