...
const Msnp32FolderIconComponent = ({
  variant = '32x32_4',
  ...rest
}: Msnp32FolderIconProps) => {
  const Svg = msnp32FolderIconData[variant];

  return <Svg {...rest} />;
};

export const Msnp32FolderIcon = React.memo(Msnp32FolderIconComponent);
