...
const Progman13Component = ({
  variant = '32x32_1',
  ...rest
}: Progman13Props) => {
  const Svg = progman13Data[variant];

  return <Svg {...rest} />;
};

export const Progman13 = React.memo(Progman13Component);
