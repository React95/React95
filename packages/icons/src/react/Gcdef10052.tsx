...
const Gcdef10052Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10052Props) => {
  const Svg = gcdef10052Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10052 = React.memo(Gcdef10052Component);
