...
const Main200Component = ({
  variant = '32x32_1',
  ...rest
}: Main200Props) => {
  const Svg = main200Data[variant];

  return <Svg {...rest} />;
};

export const Main200 = React.memo(Main200Component);
