...
const Gcdef10016Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10016Props) => {
  const Svg = gcdef10016Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10016 = React.memo(Gcdef10016Component);
