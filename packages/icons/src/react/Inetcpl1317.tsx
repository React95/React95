...
const Inetcpl1317Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1317Props) => {
  const Svg = inetcpl1317Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1317 = React.memo(Inetcpl1317Component);
