...
const Defrag7Component = ({
  variant = '32x32_4',
  ...rest
}: Defrag7Props) => {
  const Svg = defrag7Data[variant];

  return <Svg {...rest} />;
};

export const Defrag7 = React.memo(Defrag7Component);
