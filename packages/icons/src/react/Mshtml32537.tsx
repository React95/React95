...
const Mshtml32537Component = ({
  variant = '32x32_4',
  ...rest
}: Mshtml32537Props) => {
  const Svg = mshtml32537Data[variant];

  return <Svg {...rest} />;
};

export const Mshtml32537 = React.memo(Mshtml32537Component);
