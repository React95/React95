...
const Rasapi32102Component = ({
  variant = '32x32_4',
  ...rest
}: Rasapi32102Props) => {
  const Svg = rasapi32102Data[variant];

  return <Svg {...rest} />;
};

export const Rasapi32102 = React.memo(Rasapi32102Component);
