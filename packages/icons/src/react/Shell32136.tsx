...
const Shell32136Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32136Props) => {
  const Svg = shell32136Data[variant];

  return <Svg {...rest} />;
};

export const Shell32136 = React.memo(Shell32136Component);
