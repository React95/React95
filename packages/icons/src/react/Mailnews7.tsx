...
const Mailnews7Component = ({
  variant = '32x32_4',
  ...rest
}: Mailnews7Props) => {
  const Svg = mailnews7Data[variant];

  return <Svg {...rest} />;
};

export const Mailnews7 = React.memo(Mailnews7Component);
