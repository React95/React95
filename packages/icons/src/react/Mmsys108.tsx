...
const Mmsys108Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys108Props) => {
  const Svg = mmsys108Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys108 = React.memo(Mmsys108Component);
