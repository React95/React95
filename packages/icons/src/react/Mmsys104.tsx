...
const Mmsys104Component = ({
  variant = '32x32_4',
  ...rest
}: Mmsys104Props) => {
  const Svg = mmsys104Data[variant];

  return <Svg {...rest} />;
};

export const Mmsys104 = React.memo(Mmsys104Component);
