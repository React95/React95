...
const Appwiz1503Component = ({
  variant = '32x32_4',
  ...rest
}: Appwiz1503Props) => {
  const Svg = appwiz1503Data[variant];

  return <Svg {...rest} />;
};

export const Appwiz1503 = React.memo(Appwiz1503Component);
