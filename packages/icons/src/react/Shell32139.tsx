...
const Shell32139Component = ({
  variant = '32x32_4',
  ...rest
}: Shell32139Props) => {
  const Svg = shell32139Data[variant];

  return <Svg {...rest} />;
};

export const Shell32139 = React.memo(Shell32139Component);
