...
const Inetcpl1321Component = ({
  variant = '32x32_4',
  ...rest
}: Inetcpl1321Props) => {
  const Svg = inetcpl1321Data[variant];

  return <Svg {...rest} />;
};

export const Inetcpl1321 = React.memo(Inetcpl1321Component);
