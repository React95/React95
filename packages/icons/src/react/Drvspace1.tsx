...
const Drvspace1Component = ({
  variant = '32x32_4',
  ...rest
}: Drvspace1Props) => {
  const Svg = drvspace1Data[variant];

  return <Svg {...rest} />;
};

export const Drvspace1 = React.memo(Drvspace1Component);
