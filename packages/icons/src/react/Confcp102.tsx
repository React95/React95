...
const Confcp102Component = ({
  variant = '32x32_4',
  ...rest
}: Confcp102Props) => {
  const Svg = confcp102Data[variant];

  return <Svg {...rest} />;
};

export const Confcp102 = React.memo(Confcp102Component);
