...
const Gcdef10039Component = ({
  variant = '32x32_4',
  ...rest
}: Gcdef10039Props) => {
  const Svg = gcdef10039Data[variant];

  return <Svg {...rest} />;
};

export const Gcdef10039 = React.memo(Gcdef10039Component);
