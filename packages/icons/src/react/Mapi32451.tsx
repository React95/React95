...
const Mapi32451Component = ({
  variant = '32x32_4',
  ...rest
}: Mapi32451Props) => {
  const Svg = mapi32451Data[variant];

  return <Svg {...rest} />;
};

export const Mapi32451 = React.memo(Mapi32451Component);
