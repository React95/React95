import{s,c as m,j as c,t as r}from"./index-9af3809b.js";import{r as d,R as o}from"./index-ebeaab24.js";import{D as g}from"./ListDivider-1ac362e6.js";const x=""+new URL("rightcaret-f6d1f28b.svg",import.meta.url).href,h=s.li`
  position: relative;
  ...
  ${({hasList:t})=>t&&m`
    ...
    `};
`,n=d.forwardRef(({icon:t,children:e=[],...l},p)=>c(h,{...l,icon:!!t,ref:p,hasList:!!(e&&o.Children.map(e,a=>o.isValidElement(a)).some(a=>a)),className:"default",children:[t,e]}));n.displayName="List.Item";const f=n;try{List.Item.displayName="List.Item",List.Item.__docgenInfo={description:"",displayName:"List.Item",props:{icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>"}}}}}catch{}const u=s.ul`
...
//# sourceMappingURL=List-0d80d9c5.js.map
